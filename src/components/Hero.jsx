...
const Hero = ({ t }) => {
  return (
    <section
      ...
      className="relative pt-24 pb-12 sm:pt-32 sm:pb-20 lg:pt-40 lg:pb-32 overflow-hidden"
    >
      {/* floating decoration */}
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10 grid lg:grid-cols-12 gap-10 lg:gap-12 items-center">
        <div className="lg:col-span-7 relative z-10">
          <span className="tag-chip">
            <Star className="w-3.5 h-3.5" /> {t.hero.tag}
          </span>

          <h1 className="font-display text-[3.5rem] sm:text-7xl lg:text-[8rem] leading-[0.95] font-bold text-[#2D3142] mt-5">
        ...
        <div className="lg:col-span-5 relative">
          ...
          <div className="absolute -bottom-6 -left-2 sm:-left-6 bg-white rounded-3xl shadow-soft px-4 py-3 sm:px-5 sm:py-4 hidden sm:flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-[#5C6173]">{t.hero.tag}</p>
            </div>
          </div>
        </div>
      </div>
